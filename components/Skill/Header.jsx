...
export default function Header() {
  ...
  const menuItems = [
    { name: "Home", href: "/" },
    { name: "Services", href: "/services", onClick: handleServiceClick },
    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          <button className="w-full bg-yellow-500 text-black py-2 rounded-lg shadow-md hover:bg-yellow-400 transition-all">
            Enroll Now
          </button>
        </motion.div>
      )}
